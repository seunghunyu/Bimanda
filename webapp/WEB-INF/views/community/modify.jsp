...
function freeCheckForm(btn){
	...
	if (btn.form.boardTitle.value.trim().length==0){
		...
		document.freewriteaction.submit()
	}
}
</script>
<style>
...
<body>
	...
	<br/><br/><br/>
	<div class="writeform">
<form modelAttribute="boardVo" method="post" action="${pageContext.servletContext.contextPath }/community/modify?starting=${starting }" name="freewriteaction">
<input type="hidden" name="userNo" value="${authUser.userNo}">
	<input type="hidden" name="userId" value="${authUser.userId}">
 	<input type="hidden" name="boardCategory" value="${bVo.boardCategory}">
	...
	<textarea  name="boardContent" id="summernote" cols=60 rows=5>${bVo.boardContent}</textarea><br><br/><br/>
	
	<div class="makeTeamdiv" style="margin-left:17%;">
		<input class="makeTeam" type="button" value="수정하기" onclick="freeCheckForm(this)">
	</div>
</form>
</div>
<script type="text/javascript">
