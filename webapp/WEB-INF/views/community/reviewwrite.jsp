...
<body>
		...
		<div class="writeform">
			<form modelAttribute="reviewBoardVo" method="post" action="${pageContext.servletContext.contextPath }/community/writeaction" name="reviewwriteaction">
				<input type="hidden" name="userNo" value=${authUser.userNo }><br>	
				<input type="hidden" name="userId" value="${authUser.userId}"><br>
			 	<input type="hidden" name="boardCategory" value="공모전후기"><br>
				...
				<select name="cateNo" class="form-control" style="width:200px; height:40px; border: 1px solid #e0e0e0; margin-top:-10%;">
				...
				<div class="makeTeamdiv" style="margin-left:17%;">
					<input class="makeTeam" type="button" value="작성" onclick="reviewCheckForm(this)">
				</div>
			</form>
		</div>
		<script type="text/javascript">
