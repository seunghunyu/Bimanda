...
function noticeCheckForm(btn){
	...
	if (btn.form.boardTitle.value.trim().length==0){
		...
		document.noticewriteaction.submit()
	}
}
</script>
<style>
...
<body>
	...
	<br><br>
		<div class="writeform">
			<form modelAttribute="boardVo" method="post" action="${pageContext.servletContext.contextPath }/community/writeaction" name="noticewriteaction">
			<input type="hidden" name="userNo" value=${authUser.userNo }>
				...
				<div class="makeTeamdiv" style="margin-left:17%;">
					<input class="makeTeam" type="button" value="작성" onclick="noticeCheckForm(this)">
				</div>
			</form>
		</div>
		<script type="text/javascript">
