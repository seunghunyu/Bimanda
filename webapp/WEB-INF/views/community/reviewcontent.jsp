...
<jsp:include page="/WEB-INF/views/includes/header.jsp" />
	...
	<div class="section-header">
          <h3 class="section-title">${vo.boardTitle }</h3>
    ...
    <table class="table">
    	...
    	<tbody>
    		<tr class="zxc">
    			<td class="content2">${vo.boardContent }</td>
    		</tr>
    	</tbody>
	...
	<div class="back">
   				<ul>
	   				<li><a class="makeTeam" style="color: #fff;" href="${pageContext.servletContext.contextPath }/community/reviewboard">글 목록</a></li>
	   			</ul>
   			</div>
	</div>
	</div>
