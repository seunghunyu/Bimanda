...
<body>
	...
	<div class="section-header">
		...
		<div class="writeform">
			<form modelAttribute="boardVo" method="post" action="${pageContext.servletContext.contextPath }/community/writeaction" name="freewriteaction">
			<input type="hidden" name="userNo" value=${authUser.userNo }><br>	
				<input type="hidden" name="userId" value="${authUser.userId}"><br>
			 	<input type="hidden" name="boardCategory" value="자유게시판"><br>
				...
				<div class="makeTeamdiv" style="margin-left:17%;">
					<input class="makeTeam" type="button" value="작성" onclick="freeCheckForm(this)">
				</div>
			</form>
		</div>
		<script type="text/javascript">
