...
<jsp:include page="/WEB-INF/views/includes/header.jsp" />
	...
	<div class="section-header">
          <h3 class="section-title">질문게시판</h3>
    ...
    <c:if test="${!empty authUser && pageContext.request.requestURI eq '/Bimanda/WEB-INF/views/community/jisikboard.jsp' }">
		<a class="makeTeam" style="margin-left:830px; font-weight: bold; font-size: 15px; color:#fff;" href="<%= request.getContextPath() %>/community/jisikwrite">글쓰기</a>
	</c:if>
    </div>
</body>
</html>