		...
		<div class="mypage2">
			...
			onsubmit="return updateCheck(this)">
				<input type="hidden" name="userId" value=${authUser.userId }><br>
					<label for="" class="control-label">이름</label><br/>
					<label style="font-size:20px; color:#000;">${authUser.userName }</label><br/>
					<label for="아이디" class="control-label">아이디</label><br/>
					<label style="font-size:20px; color:#000;">${authUser.userId }</label><br/>
					<label for="비밀번호" class="control-label" >비밀번호</label>
					<input type="password" name="userPassword" class="form-control" placeholder="비밀번호를 입력해주세요"><br>
				...
				<div class="makeTeamdiv">
					<input style="margin-left:0%;"type="submit" value="수정" class="makeTeam">
				</div>
			</form>
		</div>
</body>
